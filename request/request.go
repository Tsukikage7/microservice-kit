// Package request 提供 HTTP 请求上下文提取的统一入口.
//
// 本包整合了多个请求上下文提取模块:
...
//
//	// 单独使用子模块
//	import "github.com/Tsukikage7/microservice-kit/request/clientip"
//	handler = clientip.HTTPMiddleware()(handler)
//
//	// 使用组合中间件
//	import "github.com/Tsukikage7/microservice-kit/request"
...
import (
	...
	"github.com/Tsukikage7/microservice-kit/request/botdetect"
	"github.com/Tsukikage7/microservice-kit/request/clientip"
	"github.com/Tsukikage7/microservice-kit/request/deviceinfo"
	"github.com/Tsukikage7/microservice-kit/request/locale"
	"github.com/Tsukikage7/microservice-kit/request/referer"
	"github.com/Tsukikage7/microservice-kit/request/useragent"
)
